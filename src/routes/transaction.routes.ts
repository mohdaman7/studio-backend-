...
router.patch('/sales/:id', authorize('sales:update'), transactionController.updateSale);
router.put('/sales/:id', authorize('sales:update'), transactionController.updateSale);
